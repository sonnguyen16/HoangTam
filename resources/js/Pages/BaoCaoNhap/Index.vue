...
import NhapKhoModal from "@/Pages/BaoCaoNhap/NhapKhoModal.vue";
...
watch(search, (value) => {
    router.visit(route('baocaonhapxuat.index', {search: value, ngay_bat_dau: ngay_bat_dau.value, ngay_ket_thuc: ngay_ket_thuc.value, loai:'nhap'}), {
        preserveState: true
    })
})
...
watch(ngay_bat_dau, (value) => {
    ...
    router.visit(route('baocaonhapxuat.index', {ngay_bat_dau: value, ngay_ket_thuc: ngay_ket_thuc.value, loai:'nhap'}), {
        preserveState: true
    })
})
...
watch(ngay_ket_thuc, (value) => {
    ...
    router.visit(route('baocaonhapxuat.index', {ngay_ket_thuc: value, ngay_bat_dau: ngay_bat_dau.value, loai:'nhap'}), {
        preserveState: true
    })
})
