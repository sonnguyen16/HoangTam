        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <span v-if="loai_san_pham.id" class="txt-color mb-0 font-weight-bold">Sửa loại sản phẩm</span>
                    <span v-else class="txt-color mb-0 font-weight-bold">Thêm loại sản phẩm</span>
